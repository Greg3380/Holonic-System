...
public class CoolWithWater extends Event {
  public final ExchangeParameters exchangeParameters;
  
  public CoolWithWater(final ExchangeParameters exchangeParameters) {
  ...
  /**
   * Returns a String representation of the CoolWithWater event's attributes only.
   */
  @SyntheticMember
  @Pure
