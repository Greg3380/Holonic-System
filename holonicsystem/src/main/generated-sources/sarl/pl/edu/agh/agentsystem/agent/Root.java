...
public class Root extends Agent {
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info("Create agent Supervisor");
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER.spawnInContext(ProductSupervisor.class, _$CAPACITY_USE$IO_SARL_CORE_INNERCONTEXTACCESS$CALLER.getInnerContext());
    ...
    _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER.wake(request);
  }
  ...
  @SyntheticMember
  public Root(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public Root(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public Root(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
