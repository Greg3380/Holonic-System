...
public class CoolWithOpenAir extends Event {
  public final ExchangeParameters exchangeParameters;
  
  public CoolWithOpenAir(final ExchangeParameters exchangeParameters) {
  ...
  /**
   * Returns a String representation of the CoolWithOpenAir event's attributes only.
   */
  @SyntheticMember
  @Pure
